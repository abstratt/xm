 ...
 * <ul>
 *   <li>{@link xmprimitives.impl.DateTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DateTypeImpl extends PrimitiveImpl implements DateType {
	...
	protected EClass eStaticClass() {
		return XmprimitivesPackage.Literals.DATE_TYPE;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmprimitivesPackage.DATE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmprimitivesPackage.DATE_TYPE__VALUE:
				return getValue();
		}
